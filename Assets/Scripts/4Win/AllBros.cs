...
public class AllBros : MonoBehaviour {
    ...
    void Awake() {
        ...
        flameEffect = (GameObject)Resources.Load("Effects/Special/Burning");
        laserEffect = (GameObject)Resources.Load("Effects/Special/BroLaser");
